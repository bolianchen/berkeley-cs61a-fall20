...
# Problem#0
# 1. What is the significance of an insect's armor attribute? Does this value
#    change? If so, how?
# Ans.: it's the remaining health of an insect. It does change after the insect
#       attacked by other insects.
# 2. What are all of the attributes of the Insect class?
# Ans.: Armor, Place, Action
# 3. Is the armor attribute of the Ant class an instance attribute of
#    class attribute? Why?
# Ans.: it's a instance attribute. Each ant is flexible to have its own
#       initial health and remaining health determined by the history of being
#       attacked by other insects(bees).
# 4. Is the damage attribute of an Ant subclass (such as ThrowerAnt) an
#    instance attribute or class attribute? Why?
# Ans.: it's a class attribute because every ThrowerAnt instance has the same
#       attribute.
# 5. Which class do both Ant and Bee inherit from?
# Ans.: Insect
# 6. What do instances of Ant and instances of Bee have in common?
# Ans.: armor, place and action
# 7. How many insects can be in a single Place at any given time
#    (before Problem 9)?
# Ans.: at most one ant in a single Place, but no limit for bees.
# 8. What does a Bee do during its turn?
# Ans.: move toward the exit of its located palce if no ant blocks its path,
#       or stings an ant otherwise.
# 9. When does the game end?
# Ans.: when any one bee reached the end of the tunnel or when all the bees
#       are vanquished.
